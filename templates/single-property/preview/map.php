...
<div class="property-preview property-preview-custom-size">
          ...
          <div  id="property-map<?php echo esc_attr($id); ?>" class="property-preview-map"  data-latitude="<?php echo (isset($maps['latitude']) ? esc_attr($maps['latitude']) : ''); ?>" data-longitude="<?php echo (isset($maps['longitude']) ? esc_attr($maps['longitude']) : ''); ?>" data-icon="<?php echo esc_url(OPALESTATE_CLUSTER_ICON_URL);?>"></div>
