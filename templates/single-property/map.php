        ...
        <div class="box-content">
                ...
                <div class="opalestate-tabs-content">
                    <div class="opalestate-tab-content" id="tab-google-map">
                        ...
                        <div  id="property-map<?php echo esc_attr($id); ?>" class="property-preview-map"  style="height:500px" data-latitude="<?php echo( isset( $maps['latitude'] ) ? esc_attr($maps['latitude']) : '' ); ?>"
                             data-longitude="<?php echo( isset( $maps['longitude'] ) ? esc_attr($maps['longitude']) : '' ); ?>" data-icon="<?php echo esc_url( OPALESTATE_CLUSTER_ICON_URL ); ?>"></div>
                    ...
                    <?php if ( $property->enable_google_mapview() ) : ?>
                        <div class="opalestate-tab-content" id="property-street-view-map" style="height:500px;">
                                <div class="property-preview property-preview-street-map" data-latitude="<?php echo (isset($maps['latitude']) ? esc_attr($maps['latitude']) : ''); ?>" data-longitude="<?php echo (isset($maps['longitude']) ? esc_attr($maps['longitude']) : ''); ?>" id="property-streep-map-<?php echo esc_attr($id); ?>">
                                </div>
                        </div>
                    <?php endif; ?>
                </div>
